			...
			return [
				...
				},
				{
					...
					content: (
						<blockquote className="blockquote">
							<p>
								Patience is the wise warrior&apos;s strongest virtue. It will guard
								you from wounds as surely as armor. It will give you insight that
								others are less keen to seek out. Now, recall the fight you just
								witnessed and ask yourselves what quality Talis lacked, and what
								that lack cost her. She&apos;ll be nursing her new wounds for days,
								simply because she could not wait for an opening.
							</p>
						</blockquote>
					),
					orientation: 'center',
					...
					content: (
						<Fragment>
							...
							<p>
								...
								nothing on the training grounds, and she disciplines his lack of
								commitment as harshly as she would any other soldier under her
								command.
							</p>
						</Fragment>
					),
				...
				},
				{
					...
					content: (
						<blockquote className="blockquote">
							<p>
								Do you know what we&apos;ve lost, Pendrake? Warend Joring is the
								duke of Torencald. The trade agreements I meant to draft between our
								duchies would have enriched the Sommers for generations and made
								both us and the Jorings two of the most powerful families in Dayle.
								I&apos;ve spent years building to this point, and in a single
								evening you&apos;ve managed to dash it all away. And for what,
								Pendrake? For a gods-damned scullion? Your children and your
								children&apos;s children will be dead and buried long before
					...
					content: (
						<Fragment>
							...
							<p>
								...
								Even so, he tries, often in vain, to mold his heir into a worthy
								successor.
							</p>
						</Fragment>
					),
					...
					content: (
						<blockquote className="blockquote">
							<p>
								...
								Tersing would be in a better spot. As it is, I hate to think what
								will come of our duchy when that boy finally becomes duke.
							</p>
							<cite className="cite">
				...
				},
				{
					...
					content: (
						<Fragment>
							...
							<p>
								Pendrake Sommer is less of a fighter than his sister, and far more
								of a romantic. Some say he would happily sell his duchy for the
								object of his affection, were he given the chance.
							</p>
						</Fragment>
					),
					orientation: 'top',
				...
				},
				{
					...
					content: (
						<blockquote className="blockquote">
							<p>
								The lady of Tersing? I wouldn&apos;t call her a lady so much as a
								force of nature. Every man who crosses blades with her lives to
								regret it&mdash;that is, if they live through the encounter at all.
							</p>
							<cite className="cite">
					...
					content: (
						<Fragment>
							...
							<p>
								...
								honing her skills with a saber and bow. As such, she&apos;s earned
								the admiration and respect of her peers in the soldiery.
							</p>
							<p>
					...
					content: (
						<blockquote className="blockquote">
							<p>
								...
								little Sylranian island called <i>Dorokilson</i>. In Daylish you
								might call it the Island of Holes. It was an apt name, for whoever
								came through there, if they&apos;d anything worth losing, we made
								sure it was lost&mdash;eaten by the Island.
							</p>
						</blockquote>
					),
					orientation: 'center',
				...
				},
				{
					...
					content: (
						<p>
							...
							the antagonist in an in-progress fantasy novel. As with much else in
							this story, Cargha is not quite what he seems at first, and his
							motivations are often nebulous.
						</p>
					),
					orientation: 'top',
					featured: true,
				...
				},
				{
					...
					content: (
						<Fragment>
							<blockquote className="blockquote">
								<p>
									Have you met the boy? I&apos;d sooner take my chances outside
									the Ark than match blades with him. Crow&apos;s his name,
									killing&apos;s his profession. And be damned certain, he&apos;s
									a professional.
									<cite className="cite">
							...
							<p>
								In it, mankind has been forced by a cataclysmic event to live in
								domed cities called Arks. When tensions between Arks escalate,
								having no means to do battle out in the uninhabitable wastelands
								between cities, governments must quell their conflicts by more
								surgical means.
							</p>
						</Fragment>
					),
				...
				},
				{
					...
					content: (
						<blockquote className="blockquote">
							<p>
								I was seventeen, by all means still a boy, yet I was possessed of
								the sort of steel-hard conviction only youth can muster that I was
								as good as a man grown. I was entirely given to my appetites,
								boisterous and inconsiderate, and a downright embarrassment to my
								father and his court. I was, in other words, a young Daylish noble.
								And, like many young Daylish nobles, I was hopelessly, stupidly,
								recklessly in love.
								<cite className="cite">
				...
				},
				{
					...
					content: (
						<Fragment>
							<blockquote className="blockquote">
								<p>
									I wouldn&apos;t call him a kind man, but he&apos;s loyal. As
									soon slug you in the face as laugh at your jesting. All depends
									on which side of him you lie on. I wouldn&apos;t want to be on
									his bad side, though. Fair lot of trouble follows those what
							...
							<p>
								Berned is Auerstel Town&apos;s constable&mdash;at times of help, at
								times an obstacle, and sometimes, when he feels like it, a downright
								villain.
							</p>
							<p>
				...
				},
				{
					...
					content: (
						<Fragment>
							...
							<p>
								This is a creature that lives on a planet whose atmosphere is so
								thick that the sense of sight never evolved, so instead this species
								developed extra-sensitive olfactory senses. Threads stretching over
								the holes in its &quot;face&quot; protect against contaminants as it
								inhales.
							</p>
						</Fragment>
					),
				...
				},
				{
					...
					content: (
						<Fragment>
							<blockquote className="blockquote">
								<p>
									Fennory is gone, Bethany. Call him dead, and leave it at that.
									Mourn him as if you&apos;d seen his body and known the stillness
									of it. There will be no peace for you until you do.
									<cite className="cite">
										<small>&mdash;Pendrake Sommer, Duke of Tersing</small>
									</cite>
								</p>
							...
							<p>
								A darker, more malevolent force whisks him away, however, forcing
								those closest to him into a desperate search, while outside their
								quiet town a greater threat, once thought defeated, rises from the
								ashes.
							</p>
						</Fragment>
					),
				...
				},
				{
					...
					content: (
						<Fragment>
							<blockquote className="blockquote">
								<p>
									The Ravens still exist, if you can believe it. Though they take
									a different form today. Different stories tell it different
									ways, but I prefer to believe they linger as men now, having
