...
export default function DefaultHead() {
	const siteTitle = 'Kyle Jorve | Illustration and Design';
	const siteDescription = 'Kyle Jorve is an illustrator, designer, and writer working primarily in the genres of fantasy and science fiction.';
