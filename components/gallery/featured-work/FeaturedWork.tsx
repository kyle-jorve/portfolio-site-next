...
export default function FeaturedWork() {
	...
	return (
		<section className={`section ${styles.featured}`} id="featured-work">
			<h2 className={`underline ${styles['featured__title']}`}>
				Featured Work
			</h2>

			<div className={`glide ${styles['featured__slider-cont']}`} ref={glideRef}>
				<div className={`glide__arrows ${styles['featured__arrows']}`} data-glide-el="controls">
					<button className="glide__arrow glide__arrow--left arrow-button arrow-button--left" aria-label="move slideshow left" data-glide-dir="<">prev</button>

					<button className="glide__arrow glide__arrow--left arrow-button arrow-button--right" data-glide-dir=">" aria-label="move slideshow right">next</button>
				</div>
			...
			<div className={styles['featured__button-row']}>
				<CustomLink to="/gallery/" className="button button--primary button--arrow">
					View Gallery
				</CustomLink>
			</div>
		</section>
